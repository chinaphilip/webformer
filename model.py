...
class webformer(tf.keras.Model):

  def __init__(self,tagsize,T2Tattentionwidth,word_embed_path, maxposition=4):
    super().__init__()
#    self.tagsize=tagsize
    self.embedding_layer=Myembeddinglayer(T2Tattentionwidth,tagsize,wordembedinit=My_init(path=word_embed_path))#T2Tattentionwidth=6,
